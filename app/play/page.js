  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-8">
      <header className="mb-6 flex items-center justify-between">
        <h1 className="text-2xl font-bold text-wgold">🎰 WINGO</h1>
      ...
      <div className="mb-6 flex items-center gap-4 rounded-xl border border-wgold/40 bg-wmaroon/60 p-4">
        {latestDraw ? (
          <>
            ...
            <span className="text-sm text-white/70">
              {drawnNumbers.length} / 90 numbers drawn
            </span>
          </>
        ) : (
      ...
      <div className="grid gap-6 md:grid-cols-[auto_1fr]">
        ...
        <div>
          <h2 className="mb-2 font-bold text-wgold">Numbers to place</h2>
